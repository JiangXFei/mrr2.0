...
/**
 * Created by lml on 2017/5/5.
 */
public class NoBodyConvertFactory extends Converter.Factory {

    public static final NoBodyConvertFactory create() {
        return new NoBodyConvertFactory();
    }

    private NoBodyConvertFactory() {
    }
